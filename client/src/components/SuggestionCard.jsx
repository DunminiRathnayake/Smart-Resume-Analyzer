    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden space-y-4">
      ...
      <div className="p-6 border-b border-gray-100">
        ...
        <p className="text-gray-600 leading-relaxed">
          {feedback || 'No job match summary was generated.'}
        </p>
      </div>
      ...
      <div className="p-6 border-b border-gray-100">
        ...
        {(!strengths || strengths.length === 0) ? (
          <p className="text-gray-500 text-sm italic">No specific strengths identified.</p>
        ) : (
      ...
      <div className="p-6 border-b border-gray-100">
        ...
        {(!weaknesses || weaknesses.length === 0) ? (
          <p className="text-gray-500 text-sm italic">No specific weaknesses identified.</p>
        ) : (
          <ul className="space-y-2 list-disc list-inside text-gray-700">
      ...
      <div className="p-6 bg-gray-50/50">
        ...
        {(!suggestions || suggestions.length === 0) ? (
          <p className="text-gray-500 text-sm italic">No specific suggestions available.</p>
        ) : (
